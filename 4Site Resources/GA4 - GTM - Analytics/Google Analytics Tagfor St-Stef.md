# Google Analytics Tagfor St-Stef
...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-CN0546MB68"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-CN0546MB68');
</script>
# 

Google Tag Manger - for St-Stef 
...
})(window,document,'script','dataLayer','GTM-PRJXPJMD');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PRJXPJMD"
