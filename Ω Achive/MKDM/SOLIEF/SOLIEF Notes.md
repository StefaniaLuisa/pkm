...
Marketing Highlight:Project Highlight: Statue of Liberty-Ellis Island Foundation – GA4/GTM Analytics Audit
...
[goog@4site.tv](mailto:goog@4site.tv)
...
- Solief Salesforce Access

  - [https://soleif.my.salesforce.com](https://soleif.my.salesforce.com/)

We have access to thier staging site:

<https://test-devruca-soleif.pantheonsite.io/my-account/edit-account/?verified=1>

WP Account Access

<https://www.statueofliberty.org/my-account/user-dashboard/>

Account password reset and saved in 1Pass



YOu have been added to a new Google Analytics 4 / Google Tag Manager project that will roughly consist of: 
Rough Scope of Work

Hourly Rate:~~$275 hr~~.We are extending our discounted Retainer price of $210 /hr
Scope: 23 hours
Estimated budget:~~$6,325~~$4,830
Timeline: 4-6 weeks

### Week 1–2: Discovery & Audit

- Kickoff meeting to align on project goals and deliverables - ensure we have access to all accounts

- GA4 property audit events, conversions, ecommerce settings, referral exclusions

- GTM container review of tags, triggers, variables

- Evaluate the tracking implementation for different channels / sources

### Week 2–3: Recommendations & Planning

- Detailed audit findings and prioritize recommended fixes

- Consent management/CookieYes troubleshooting

### Week 3–5: Implementation

- Fixes and updates in GTM and GA4 based on approved plan

- Debugging, QA, and event validation with test transactions/form submissions etc.

### Week 6: Reporting & Handoff

- Walkthrough of tracking improvements and updated documentation

- Final recommendations for ongoing campaign tracking

- Discuss opportunities to continue our work together.

Your client has answered your GA4/GTM Audit Questionarrie - Please read through - provide the key information and list the project and site's goals and how you will work to achieve them as well as a list of the questions that are still outstanding from the Client.
...
*
Prepared for: Eliza Slone, MK Direct Marketing & Communications, LLC (on behalf of the Statue of Liberty-Ellis Island Foundation)
Prepared by: Stef Jones, 4Site Studios*

*Last Update: 5/29/2025*

Related Links

1. SOW [4Site-MKDM 2025 SOLEIF Web Services Agreement](https://docs.google.com/document/d/1SOLJxS2wjarV8u-a96hBmrgo4rrkVXWis64wLYDxsts/edit?tab=t.0#heading=h.1rvwp1q)
...
Update on the final adjustments to the account creation events

---

Questionarre: <https://docs.google.com/document/d/1gBDm7VvIeMU18o_9gXbvMZz8vmsHfORtV13yd91M4L4/edit?tab=t.uzzea3xxtvwk>
...
Work Done on - Monday, June 9 9:49 PM

Reconfigured connection and should be good to go from here.

Test and review tags on pages tomorrow

First Checking Main Domain: <https://www.statueofliberty.org>

Noticed this note in the console log:

> JQMIGRATE: Migrate is installed, version 3.4.1[ ](https://www.statueofliberty.org/)[www.statueofliberty.org:2](http://www.statueofliberty.org:2)[:13285](https://www.statueofliberty.org/)
>
...
&lt;script src="[https://www.google.com/recaptcha/api.js?onload=CaptchaCallback&render=explicit"&gt;&lt;/script&gt;](https://www.google.com/recaptcha/api.js?onload=CaptchaCallback&render=explicit%22%3E%3C/script%3E)

&lt;script src="[https://www.google.com/recaptcha/api.js?onload=checkoutCaptchaCallback&render=explicit"&gt;&lt;/script&gt;](https://www.google.com/recaptcha/api.js?onload=checkoutCaptchaCallback&render=explicit%22%3E%3C/script%3E)

&lt;script&gt;(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':newDate().getTime(),event:'gtm.js'});varf=d.getElementsByTagName(s[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='<https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f)>;})(window,document,'script','dataLayer','**GTM-WBLV3GH**');&lt;/script&gt;

## #GA4 Measurement ID: G-SZMLWFR2XE

## Google Tag Manager IDs:

G-SZMLWFR2XE - This tag is not added correctly

GT-WPDCDNV

Google Tag Manager - Install Instructions:

&lt;!-- Google tag (gtag.js) --&gt; &lt;script async src="[https://www.googletagmanager.com/gtag/js?id=G-SZMLWFR2XE"&gt;&lt;/script&gt;](https://www.googletagmanager.com/gtag/js?id=G-SZMLWFR2XE%22%3E%3C/script%3E) &lt;script&gt; window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-SZMLWFR2XE'); &lt;/script&gt;