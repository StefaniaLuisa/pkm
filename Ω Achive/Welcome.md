...
- [x] Create a new note inside the folder (right click the folder to get context menu)

- [x] Go to **Daily Desk** and create some day notes

- [x] **Pin** a note to quickly access in Pinned Notes

- [x] Play around with the settings

- [x] Check out the Keyboard Shortcuts from the `?` button on the bottom right

- [x] Send me bugs/feedback/thoughts!
